...
class AccuracyTargetPercentModel extends AccuracyTargetPercentEntity {
  const AccuracyTargetPercentModel(
      {int? id,
  ...
  factory AccuracyTargetPercentModel.fromEntity(
      AccuracyTargetPercentEntity entity) {
    return AccuracyTargetPercentModel(
      id: entity.id,
  ...
  factory AccuracyTargetPercentModel.fromMap(Map<String, dynamic> map) {
    return AccuracyTargetPercentModel(
        id: map['id'],
