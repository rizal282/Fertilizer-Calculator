...
class ResultCountWeightFertilizerMixModel
    extends ResultCountWeightFertilizerMixEntity {
  const ResultCountWeightFertilizerMixModel(
      {int? id,
  ...
  factory ResultCountWeightFertilizerMixModel.fromEntity(
      ResultCountWeightFertilizerMixEntity entity) {
    return ResultCountWeightFertilizerMixModel(
      id: entity.id,
  ...
  factory ResultCountWeightFertilizerMixModel.fromMap(
